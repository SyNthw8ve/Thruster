...
from thruster.networks.agent_network import AgentNetwork
...
class QNetwork():
    ...
    def train(self, policy_name, num_iterations=20000, initial_collect_steps=1000,
        ...
        self.save_policy(policy_name, tempdir)
    ...
    def save_policy(self, policy_name, tempdir):
        ...
        print(f"Policy {policy_name} saved to {policy_dir}")
